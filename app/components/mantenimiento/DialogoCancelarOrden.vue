<template>
  <v-dialog :model-value="modelValue" max-width="480" @update:model-value="onUpdateModelValue">
    <v-card class="app-modal-shadow" variant="flat">
      <v-card-title>Cancelar orden de mantenimiento</v-card-title>
      <v-card-text>
        <p class="text-body-main mb-4">
          Esta acción es permanente: la orden quedará cancelada y no podrá reactivarse ni
          editarse, incluidas sus líneas.
        </p>
        <v-textarea
          v-model="motivo"
